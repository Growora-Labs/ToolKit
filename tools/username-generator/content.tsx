      ...
      <div>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.75, color: 'var(--ink-2)' }}>
            This generator offers four distinct style presets so the output matches the platform and context: a casual fun style for social media, a professional style for LinkedIn and portfolios, a gamer style for Discord and Twitch, and a minimal style for platforms with strict character limits.
          </p>
        </section>
