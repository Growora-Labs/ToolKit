      ...
      <div>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.75, color: 'var(--ink-2)' }}>
            JSON uses two structures: <strong style={{ color: 'var(--ink)' }}>objects</strong> (key-value pairs in curly braces) and <strong style={{ color: 'var(--ink)' }}>arrays</strong> (ordered lists in square brackets). Values can be strings, numbers, booleans, null, objects, or arrays — fully nestable. The full specification is defined in <a href="https://www.rfc-editor.org/rfc/rfc8259" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)', textDecoration: 'underline' }}>RFC 8259</a>.
          </p>
        </section>
