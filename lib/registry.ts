...
export const TOOLS: ToolMeta[] = [
  ...
  /* ── Coming soon — Design ───────────────────────────── */
  {
    ...
    description:    'Convert colors between HEX, RGB, HSL, HSV and CSS formats instantly.',
    seoTitle:       'Free Color Converter Online — HEX to RGB, HSL & More | ToolKit',
    seoH1:          'Free Color Converter Online',
    seoDescription: 'Convert colors between HEX, RGB, HSL, HSV and CSS formats instantly. Live color preview. Free online color converter — no signup required.',
    category:       'Design',
    keywords:       ['color converter', 'hex to rgb', 'rgb to hex', 'hsl to hex', 'color format converter online'],
    live:           false,
  },
  {
